...
final readonly class WalkingListing
{
    public const OPERATION_ID = 'pets/kinds/walking';
    public const OPERATION_MATCH = 'LIST /pets/kinds/walking';
    ...
    {
        $operation = new \ApiClients\Client\PetStore\Internal\Operation\Pets\Kinds\WalkingListing($this->responseSchemaValidator, $this->hydrator, $perPage, $page);
