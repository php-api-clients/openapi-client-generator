...
final class PetsList
{
    ...
    public function gatos(array $params) : iterable
    {
        ...
        unset($params['page']);
        $operator = new Internal\Operator\Pets\List_\Gatos($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Pets🌀Gatos());
