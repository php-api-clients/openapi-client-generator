...
final class CreatePets
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(Schema\CreatePets\Request\ApplicationJson::SCHEMA_JSON, \cebe\openapi\spec\Schema::class));
