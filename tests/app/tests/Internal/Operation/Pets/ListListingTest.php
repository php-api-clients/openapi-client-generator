...
/**
 * @covers \ApiClients\Client\PetStore\Internal\Operation\Pets\ListListing
 */
final class ListListingTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function call_httpCode_default_responseContentType_application_json_zero()
    {
        ...
        $result = $client->call(Internal\Operation\Pets\ListListing::OPERATION_MATCH, (static function (array $data) : array {
            $data['per_page'] = 8;
            $data['page'] = 1;
            return $data;
        })(array()));
