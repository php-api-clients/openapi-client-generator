...
/**
 * @covers \ApiClients\Client\PetStore\Internal\Operation\Pets\Names
 */
final class NamesTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function call_httpCode_default_responseContentType_application_json_zero()
    {
        ...
        $result = $client->call(Internal\Operation\Pets\Names::OPERATION_MATCH, (static function (array $data) : array {
            $data['per_page'] = 8;
            $data['page'] = 1;
            return $data;
        })(array()));
