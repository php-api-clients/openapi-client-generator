...
/**
 * @covers \ApiClients\Client\PetStore\Operation\Pets\List_\GatosListing
 */
final class GatosListingTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    /**
     * @test
     */
    public function call_httpCode_default_responseContentType_application_json_zero()
    {
        ...
        $result = $client->call(Operation\Pets\List_\GatosListing::OPERATION_MATCH, (static function (array $data) : array {
            $data['per_page'] = 8;
            $data['page'] = 1;
            return $data;
        })(array()));
